...
if (!isMobile()) {
	if(languageCode ==='ko') {
		window.location.href = "./parata-air-web/pc/ko.html"; // 이동할 링크
	}else{
		window.location.href = "./parata-air-web/pc/en.html";
	}
}else{
	if(languageCode ==='ko') {
		window.location.href = "./parata-air-web/mobile/ko.html";
	}else{
		window.location.href = "./parata-air-web/mobile/en.html";
	}
}
...
var prata = {
	...
	sectionFixed: function(){
		...
		if(sec4Bound.top < 0 && sec4Bound.bottom - $(window).height() > 0) {
			...
			if(sec4TextSecond.bottom - 350 <= 0){
		...
		let sec31TopSixthText = document.querySelector(".section31 .top-wrap .text-wrap .sixth").getBoundingClientRect();
		let sec31TopSeventhText = document.querySelector(".section31 .top-wrap .text-wrap .seventh").getBoundingClientRect();
		...
		let sec31BottomSixthText = document.querySelector(".section31 .bottom-wrap .sixth").getBoundingClientRect();
		...
		if(sec31TopSixthText.top <= $(window).height() * 0.85){
			$(".section31 .top-wrap .text-wrap .sixth div").each(function (index) {
				setTimeout(() => {
					$(this).addClass("on");
				}, index * 100); // index에 따라 0.1초(100ms)씩 증가
			});
		...
		if(sec31TopSeventhText.top <= $(window).height() * 0.85){
			$(".section31 .top-wrap .text-wrap .seventh div").each(function (index) {
				setTimeout(() => {
					$(this).addClass("on");
				}, index * 100); // index에 따라 0.1초(100ms)씩 증가
			});
		...
		if(sec31BottomSixthText.top <= $(window).height() * 0.85){
			$(".section31 .bottom-wrap .sixth div").each(function (index) {
				setTimeout(() => {
					$(this).addClass("on");
				}, index * 100); // index에 따라 0.1초(100ms)씩 증가
			});
